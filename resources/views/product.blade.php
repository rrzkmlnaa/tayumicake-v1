...
<body>
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('/product') }}">List Product</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="main">
        <div class="container-fluid container-fluids">
            ...
            <div class="row my-3">
                @foreach ($products as $product)
                    <div class="col-6 col-md-3">
                        <div class="card">
                            <img src="{{ $product->picture }}" class="card-img-top" height="200px"
                                alt="{{ $product->name }}">
                            <div class="card-body">
